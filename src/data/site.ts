...
export const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/assets/projects/Eagle.png",
  ...
  },
  {
    ...
    url: "https://huggingface.co/spaces/jacksonwambali/Intelligent_SMS_Scam_Detection_for_Swahili_and_English",
  },
  {
  ...
  },
  {
    ...
    image: "/assets/projects/Energy.jpg",
  },
  {
    title: "Smart Scare Crow System",
    tag: "AgriTech IoT",
    desc: "Field-ready smart scarecrow concept designed to help farmers protect crops by detecting field activity and triggering automated deterrent responses.",
    image: "/assets/projects/Scare Crow.jpg",
    highlights: [
      "Built around practical crop-protection needs for small and medium farms.",
      "Combines electronics, sensing and automation for field deployment.",
      "Designed to reduce manual guarding and support smarter farm management.",
    ],
  },  {
    title: "Soil Monitoring",
    tag: "IoT Agriculture",
    desc: "This system enables users to monitor soil parameters remotely through a web browser from anywhere in the world. By collecting real-time data from soil sensors, it continuously tracks key parameters such as soil moisture, temperature, humidity, and pH levels. The system provides accurate and timely information to support informed decision-making, helping users optimize irrigation, improve crop productivity, reduce water wastage, and respond quickly to changing soil conditions without the need to be physically present at the farm.",
    image: "/assets/projects/iot1.png",
    url: "https://iot-sensor-dashboard-black.vercel.app/",
  },
  {
    title: "Solar adaptive Charging using AI",
    tag: "Artificial Intelligence",
    desc: "This system is designed for hospitals that are not connected to the power grid or rely on solar energy without intelligent energy management. It uses Artificial Intelligence (AI) and 15-day weather forecasts to predict solar energy availability and optimize battery State of Charge (SoC). The AI intelligently controls battery charging and discharging while prioritizing critical hospital loads, ensuring a reliable power supply, improving energy efficiency, extending battery lifespan, and reducing the risk of power shortages during periods of low solar generation.",
